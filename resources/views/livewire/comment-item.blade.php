<div class="flex justify-between mb-4 gap-3">
    ...
    <div class="flex-1">
        ...
        @endif
        <div>
            <a wire:click.prevent="startReply" href="#" class="text-sm text-indigo-600 mr-3">Repondre</a>
            @if (\Illuminate\Support\Facades\Auth::id() == $comment->user_id)
                <a wire:click.prevent="startCommentEdit" href="#" class="text-sm text-blue-600 mr-3">Modifier</a>
