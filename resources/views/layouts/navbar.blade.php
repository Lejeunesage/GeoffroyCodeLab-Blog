  ...
  <div class="container">
    <div class="flex -mx-4 items-center justify-between relative">
      ...
      <div class="flex px-4 justify-end items-center w-full">
        <div>
          <x-layout.navbar-humburger @click="navbarOpen = !navbarOpen"
                                     x-bind:class="navbarOpen && 'navbarTogglerActive'"></x-layout.navbar-humburger>
          <nav
          ...
          >
            <ul class="block lg:flex lg:items-center">
              ...
              <div class="ml-0 lg:ml-10 xl:ml-16 relative top-1">
                <div class="g-ytsubscribe" data-channelid="UC4o6gBv71UMlwlQSLzm8blw" data-layout="default"
