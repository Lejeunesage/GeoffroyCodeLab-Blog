<div {{ $attributes->merge(['class' => 'flex items-center']) }}>
    ...
    <a href="https://www.linkedin.com/in/geoffroy-otegbeye-287038247" target="_blank"
        class="
         w-10
         h-10
         flex
         ...
         xl:mr-4
    ">
        <svg width="20" height="15" viewBox="0 0 15 16" class="fill-current">
            <path
    ...
    <a href="https://www.youtube.com/channel/UC4o6gBv71UMlwlQSLzm8blw/featured" target="_blank"
        class="
         w-10
         h-10
         flex
