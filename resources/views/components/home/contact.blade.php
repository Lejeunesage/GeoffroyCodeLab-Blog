            ...
            <div class="w-full lg:w-1/2 xl:w-6/12 px-4">
                <div class="max-w-[570px] mb-12 lg:mb-0">
                    ...
                    <p class="text-base text-body-color dark:text-gray-200 leading-relaxed mb-9">
                        Si vous pensez que mon expérience et mes compétences correspondent à vos besoins, n'hésitez pas
                        à me contacter.
                    </p>
            ...
            <div class="w-full lg:w-1/2 xl:w-5/12 px-4">
                <div class="bg-white dark:bg-slate-900 relative rounded-lg p-8 sm:p-12 shadow-lg">
                    <form action="/contact/submit" method="POST" x-data="{
                        ...
                        submitForm(event) {
                            ...
                            fetch(event.target.action, {
                                ...
                                .then(result => {
                                    ...
                                    this.successMessage = 'Merci pour votre demande de contact. Je reviens vers vous dans peu de temps.';
                                })
                        ...
                        @csrf
                        <div class="mb-6">
                            <x-forms.input placeholder="Votre Nom" name="name" x-model="formData.name"
                        ...
                        <div class="mb-6">
                            <x-forms.input type="email" placeholder="Votre Email" name="email"
                        ...
                        <div class="mb-6">
                            <x-forms.textarea placeholder="Votre message" name="message" rows="6"
